        ...
        $notefile = '../notes/'. $branch . '/' . $subject . '/' . $module;
            ...
            foreach($filesInFolder as $file){
                ...
                if (mysqli_num_rows($result) > 0) { 
                    ...
                    <td style='text-align:left'><a href='/$downloadPath/".$notes["title"]."'>".$notes["title"]." </a></td>
                    ...
                    <td><form method='post'><input type='number'  name='note_id'  value='".$notes["id"]."' hidden/>
                    <input name='branch'  value='".$branch."' hidden/>
                    <input name='subject'  value='".$subject."' hidden/>
                    <input name='module'  value='".$module."' hidden/>
