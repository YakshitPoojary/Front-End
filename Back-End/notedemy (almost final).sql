...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2023 at 10:58 AM
...
INSERT INTO `note` (`id`, `title`, `ext`, `desc`, `status`, `user_id`, `directory`) VALUES
...
(21, '1.3 Impact of data science on bussiness.pdf', 'pdf', 'This file was shared by Vaibhav Sir', 1, 1, 'Computer Science/Honours/Module 1'),
(22, '1.2 Introduction to Applied Data Science.pdf', 'pdf', 'This file was shared by Vaibhav Sir', 1, 1, 'Computer Science/Honours/Module 1'),
(23, '1.4 Intro to need of estimation and validation.pdf', 'pdf', 'Downloaded From Lms', 0, 3, 'Computer Science/Honours/Module 1'),
(24, '1.5 Variation.pdf', 'pdf', 'This are my notes please share your opinion on these notes. I would like to know if you like the style of notes and how can I improve it. please contact by email on Salman.m@somaiya.edu(this was a test msg to see how many char can be displayed)', 1, 3, 'Computer Science/Honours/Module 1'),
(25, '1.6 Probability Distribution.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 1'),
(26, '1.7 Statistical Inference Foundations.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 1'),
(27, 'Graph-SNM.ppt', 'ppt', '', 0, 2, 'Computer Science/Data Structure/Non-linear data structures: Tree and Graph '),
(28, 'Searching-SNM-21-22.pptx', 'pptx', '', 1, 2, 'Computer Science/Data Structure/Searching and Sorting'),
(29, 'Set-Maps-Dictionary.pdf', 'pdf', '', 1, 2, 'Computer Science/Data Structure/Set, Map and Dictionary'),
(30, 'sorting-SNM-21-22.pptx', 'pptx', '', 1, 2, 'Computer Science/Data Structure/Searching and Sorting'),
(31, 'Trees-SNM.pptx', 'pptx', '', 0, 2, 'Computer Science/Data Structure/Non-linear data structures: Tree and Graph '),
(32, 'Trees-SNM.pptx', 'pptx', '', 0, 2, 'Computer Science/Data Structure/Non-linear data structures Tree and Graph '),
(33, 'Graph-SNM.ppt', 'ppt', '', 0, 2, 'Computer Science/Data Structure/Non linear data structures Tree and Graph '),
(34, '1.8 Data Scrapping.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 1'),
(35, 'Achieving-business-impact-with-data_FINAL.PDF', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 1'),
(36, 'Applied Data Science Module 1-3.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 1'),
(37, 'PMF, PDF, CDF.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 1'),
(38, 'Probability Distributions.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 1'),
(39, '2.1 Open Source Modelling in R.pptx', 'pptx', '', 1, 3, 'Computer Science/Honours/Module 2'),
(40, '2.2 Finance Models.pptx', 'pptx', '', 1, 3, 'Computer Science/Honours/Module 2'),
(41, 'Question Bank for H-ADS Module 2.txt', 'txt', '', 1, 3, 'Computer Science/Honours/Module 2'),
(42, '3.1 Introduction to EDA.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 3'),
(43, '3.2 Data preprocessing.pdf', 'pdf', '', 0, 2, 'Computer Science/Honours/Module 3');
...
(1, 'Yakshit', 'Poojary', 'yakshit@gmail.com', '$2y$10$o1FYUvAff57Etqii9avDROxJi/kGF.POp3p8Bqjwz1V1dkaoghj6q', 'Yakshit', 1, 1, 0),
(2, 'Salman', 'Moghul', 'salman@gmail.com', '$2y$10$MY3VJAmmGkufsY9gC0oWHu/NZZAI85fLsoprRfT7WZLJDdYiPKByC', 'Sallu007', 1, 1, 0),
(3, 'Vaibhav', 'Vasani', 'Vaibhav.v@somaiya.edu', '$2y$10$5ZS0gRSVaaKDPlANzEGdVeFTt7SX52uaSv7NLERrPhuflXD.rCORC', 'Vaibhav', 1, 0, 1),
(17, 'Moksh', 'Mehta', 'moksh.m@somaiya.edu', '$2y$10$pDBCC4P5zGSq3E4FFp3kUu/ffb.dvxGeBsfrva2GdYLyGNh7ZXvmC', 'mokashhh', 2, 1, 1),
(32, NULL, NULL, 'priyal.keharia@somaiya.edu', NULL, NULL, NULL, 0, NULL),
(33, NULL, NULL, 'rashika.a@somaiya.edu', NULL, NULL, NULL, 0, NULL),
(34, 'raj', 'ma', 'raj.ma@somaiya.edu', '$2y$10$TQ3DnUIUv44mVm946G8xveKb82fQcCHj1iSEcpOghs.2a2ngB266C', 'raju', 1, 1, 1),
